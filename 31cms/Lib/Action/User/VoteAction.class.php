...
class VoteAction extends UserAction
{
    ...
    public function add()
    {
        ...
        if (IS_POST) {
            ...
            //自定义一系列功能
            $IIIIIllIl1I1['isviewcount'] = $this->_post('isviewcount');
            $IIIIIllIl1I1['isshownew'] = $this->_post('isshownew');
            $IIIIIllIl1I1['isDesc'] = $this->_post('isDesc');
            $IIIIIllIl1I1['innerText'] = $this->_post('innerText');
            $IIIIIllIl1I1['isavote'] = $this->_post('isavote');
            $IIIIIllIl1I1['isplenty'] = $this->_post('isplenty');
            $IIIIIllIl1I1['sharecontent'] = $this->_post('sharecontent');
            $IIIIIllIl1I1['groupLimit'] = $this->_post('groupLimit');
