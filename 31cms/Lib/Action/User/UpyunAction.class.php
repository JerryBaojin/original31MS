	...
	function kindedtiropic(){
		if ($this->upload_type=='upyun'){
			...
			if ($return['error']){
				...
				$tietuku = M('Users')->where(array('id'=>'1'))->find();	
				
					if($tietuku['tuchuang']){
						
						$msg = $this->tcupload($return['msg'],$tietuku['tuaccesskey'],$tietuku['tusecretkey'],$tietuku['tupicid']);
		...
		function tcupload($IIIIIlI11II1,$IIIII11I1ll1,$IIIII11I1l1I,$IIIII11I1l1l){import('@.ORG.TieTuKu');$IIIII11I1l11=new TTKClient($IIIII11I1ll1,$IIIII11I1l1I);$IIIIIII11l11=$IIIII11I1l11->uploadFile($IIIII11I1l1l,$IIIIIlI11II1);$IIIIIII11l11 = str_replace("{","",$IIIIIII11l11);$IIIIIII11l11 = str_replace("}","",$IIIIIII11l11);$IIIIIII11l11 = str_replace('"',"",$IIIIIII11l11);$IIIIII1l1l11 = explode(',',$IIIIIII11l11);$IIIII11I11II = str_replace('s_url:',"",$IIIIII1l1l11[7]);if($IIIII11I11II){$IIIII11I11II = $this->qukuohao($IIIII11I11II);return stripslashes($IIIII11I11II);}else{return NULL;}} function qukuohao($str){ $result = array(); preg_match_all("/(?:\()(.*)(?:\))/i",$str, $result); return $result[1][0]; }
	...
	function localUpload($filetypes=''){
		...
		if(!$upload->upload()) {// 上传错误提示错误信息
			...
			if ($thumb==1){
				...
				$tietuku = M('Users')->where(array('id'=>'1'))->find();	
				if($tietuku['tuchuang']){
					$msg = $this->tcupload($msg,$tietuku['tuaccesskey'],$tietuku['tusecretkey'],$tietuku['tupicid']);
				}
			}else {
