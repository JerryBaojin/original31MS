...
<body>
<div id="allgonggao" style="width:100%;height:25px;background:rgba(0,0,0,0.6); position:fixed;top:0;z-index:2000; line-height:25px;">
...
<section class="content" id="get_info" data-rid="503" data-sort="" data-kw="" data-page="">
    <div class="text_a clearfix" id="sort">
        ...
        <a href="<?php echo U('Vote/top',array('token'=>$token,'id'=>$id));?>" >TOP300</a>
    </div>
