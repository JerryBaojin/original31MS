...
<script type="text/javascript" src="<?php echo STATICS;?>/vote/js/lrz.all.bundle.js"></script>
            ...
            <dl class="upload clearfix">
                ...
                <dd class="upload_area clearfix">
                    ...
                    <div class="upload_btn">
                        ...
                        <input type="file" id="upload_image" value="图片上传" accept="image/*" >
        ...
        document.querySelector('#upload_image').addEventListener('change', function () {
            ...
            lrz(this.files[0], {
                ...
                .then(function (result) {
                    ...
                    + result.base64.replace(/^(data:\s*image\/(\w+);base64,)/g, '') + '">');
...
$(function($){
	...
	$("#signupok").submit(function(){
		...
		var telreg = /^1[3|4|5|6|7|8][0-9]\d{8}$|^\d{8}$/;
