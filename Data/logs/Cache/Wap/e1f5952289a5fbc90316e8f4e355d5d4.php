...
<div id="allgonggao" style="width:100%;height:25px;background:rgba(0,0,0,0.6); position:fixed;top:0;z-index:2000; line-height:25px; max-width: 640px;">
...
<header>
    ...
    <div class="m_head clearfix">
        ...
        <div class="num_box">
            <?php if($vote['isavote'] == 0): if($ishavezp == 1): ?><a href="<?php echo U('Vote/detail',array('token'=>$token,'id'=>$id,'zid'=>$havezpid));?>" class="join_us">我的参赛</a>
                    <?php elseif($istime == 1): ?>
                    <a href="<?php echo U('Vote/signup',array('token'=>$token,'id'=>$id));?>" class="join_us">我要报名</a>
...
<script>
    ...
    text-align: center;
    color: yellow;    margin-top: 15px;
    font-size: 17px;">浏览量:<?php echo ($check); ?></div>
        ...
        <div class="search">
            <form action="<?php echo U('Vote/search');?>" id="search_form" method="post" accept-charset="utf-8">
                ...
                <div class="search_con">
                    ...
                    <div class="text_box"><input type="search" id="searchText" value="" name="keyword" placeholder="<?php echo ($vote['innerText']); ?>"></div>
                </div>
            </form>
        </div>    </div>
</header>
...
<div class="text_a clearfix" id="sort">
    <?php if( $vote["isshowNew"] == 1): ?><a href="<?php echo U('Vote/index',array('token'=>$token,'id'=>$id));?>" class="active">参赛列表</a>
        <?php else: ?>
        <a href="<?php echo U('Vote/index',array('token'=>$token,'id'=>$id));?>" class="active">最新参赛</a><?php endif; ?>
    <a href="<?php echo U('Vote/rank',array('token'=>$token,'id'=>$id));?>" >投票排行</a>
    <?php if( $vote.$isshowNew == 1 ): ?><a href="<?php echo U('Vote/top',array('token'=>$token,'id'=>$id));?>" >TOP300</a>
        <?php else: ?>
        <style>
            .content .text_a a{
...
<ul>
<li class="rank-head"><span style="width:13%;">排名</span><span style="width:12%;">编号</span><span style="display:inline-block;<?php if(($id !=20) and ($id !=23)): ?>width:23%<?php else: ?>width:48%;<?php endif; ?>" >
<?php if($id !=20): if($id == 23): ?>项目名称
        <?php else: ?>
            选手<?php endif; ?>
...
<li class="list"><span style="width:11%;"><?php echo ($i); ?></span><span style="width:12%;"><?php echo ($list['id']); ?></span><span style="display:inline-block;<?php if(($id != 20) and ($id !=23)): ?>width:23%<?php else: ?>width:52%;<?php endif; ?>"><?php echo ($list['item']); ?></span><span style="width:22%;color:#f67685;display:none"><?php echo ($list['dcount']); ?></span><span style="width:25%;color:#f67685"><?php echo ($list['vcount']); ?></span></li></a><?php endforeach; endif; else: echo "" ;endif; ?>
...
$(function($){
	$("#search_form").submit(function(){
		...
		if(keyword.length == 0){alert('请输入<?php if($id ==20): ?>视频名字<?php elseif($id==23): ?>项目名称<?php else: ?>选手姓名<?php endif; ?>或编号');return false;}
	});
});
    $(function(){
