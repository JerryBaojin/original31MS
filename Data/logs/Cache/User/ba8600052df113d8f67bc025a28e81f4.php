...
<?php echo ($key["content"]); ?>
				 ...
				 <tr>
                 	<td colspan="2"  align="center"><button type="submit" name="button" class="btn btn-primary btn_submit  J_ajax_submit_btn">添加</button></td>
                 	</tr> 
				</tbody>
				</table>
