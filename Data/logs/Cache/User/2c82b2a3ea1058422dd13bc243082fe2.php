          ...
          <div class="msgWrap">
            <table class="CC_table" border="0" cellspacing="0" cellpadding="0" width="100%" >
              <tbody>
				...
				<tr>
					<th>&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">*</span>域名配置</th>
					<!--value="<?php echo ($info['myzps']); ?>"-->
					<td><input type="text" class="px"  value="<?php echo ($websiteurl[0]['url']); ?>"  name="url"></td>
				</tr>
                  	<tr>
              ...
              <tr>
               ...
               <tr>
                	<th>&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">*</span>作品图片上传数限制(1-4)</th>
			   ...
			   <tr>
				...
				<tr>
                	...
                	<td><input type="text" class="px"  value="<?php echo ($info['dbdhurl']); ?>" name="dbdhurl">&nbsp&nbsp&nbsp&nbsp(页面右下角菜单链接）(<font color="red" >---做好关注链接之后请到百度缩短去缩短一下链接,不然可能会出错---</font><font color="green" size="5px"><a href="http://dwz.cn/" target="blank">http://dwz.cn/</a></font>)</td>
                </tr> 
				<tr>
				 <!--
				 <tr>
				...
				<tr>
                	...
                	<td><input type="text" class="px"  value="<?php echo ($diymen['appid']); ?>" name="appid">&nbsp&nbsp&nbsp&nbsp(公众号后台开发中心-基本配置（右侧）)</td>
                </tr> 
				<tr>
                	<th>&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">*</span>公众号appsecret</th>
                	<td><input type="text" class="px"  value="<?php echo ($diymen['appsecret']); ?>" name="appsecret">&nbsp&nbsp&nbsp&nbsp(公众号后台开发中心-基本配置（右侧）)</td>
                </tr> 
				<!-- <tr>
