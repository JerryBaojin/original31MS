		   ...
		   <tr>
			...
			<div>票数：<input type="text" id="addvcount" size="30" class="msgtext" style="width:70%;" >
			 ...
			 <div>电话：<input type="text" id="addtourl"  size="30" class="msgtext" style="width:70%;"></div>
               <div>分组：<input type="text" id="group"  size="30" class="msgtext" style="width:70%;"></div><B>选填</B>
			<div>封面照片：<input type="text" id="addstartpicurl"  size="30" class="msgtext" style="width:50%;" >
					...
					<div> 照片2： <input type="text" id="addstartpicurl2" size="30" class="msgtext" style="width:50%;" >
					...
					<div> 照片3： <input type="text" id="addstartpicurl3"  size="30" class="msgtext" style="width:50%;" >
					...
					<div> 照片4： <input type="text" id="addstartpicurl4" size="30" class="msgtext" style="width:50%;" >
