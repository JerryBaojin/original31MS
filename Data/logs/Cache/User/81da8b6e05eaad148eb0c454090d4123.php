...
<div class="content">
		  ...
		  <a href="<?php echo U('User/Vote/addplayer',array('token'=>$_GET['token'],'id'=>$_GET['id']));?>" class="right btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-27px;margin-right:20px;">添加新选手</a> 
          ...
          <form method="post" action="" id="info">
              ...
              <tbody>
				...
				<a href="<?php echo U('User/Vote/tpjl',array('zid'=>$list['id'],'vid'=>$vid));?>"  name="tpjl" id="tpjl" class="btn btn-primary btn_submit ">
				   投票记录
					...
					<a href="/Data/conf/auto.php?zid=<?php echo ($list["id"]); ?>" target="_blank"  name="tpjl" id="tpjl" class="btn btn-primary btn_submit ">
				   自动加票
					</a>
                  </td>
		   ...
		   <table>
			...
			<div>当前票数为：<?php echo ($list["vcount"]); ?>	&nbsp;&nbsp;<input type="radio" name="countadd" checked="checked" id="countadd" value="up" value=""/><label style="display:inline" for="countadd"> 加票</label>
			...
			<div>取消关注失去票数：当前数量为：<?php echo ($list["dcount"]); ?>	&nbsp;&nbsp;<input type="radio" name="dcountadd" checked="checked" id="dcountadd" value="up" value=""/><label style="display:inline" for="countadd"> 增加</label>
