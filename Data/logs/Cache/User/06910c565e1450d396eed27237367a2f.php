...
<td width="17"><input style="height:30px;width:750px" type="text" name="keyword" value="<?php if($vo['keyword'] == ''): ?>投票<?php else: echo ($vo["keyword"]); endif; ?>" class="px" style="width:550px;"><br><span class="red">只能写一个关键词，请不要与其它活动的关键词重复。</span></td>
</tr>


<tr class="sub">
    <th width="83">是否强制关注才能参与活动：</th>
                 <?php if($vo["ismustsub"] == 1): ?><td width="127"><label style="display:inline-block">是</label>
                     <input style="width: 28px;height:20px;margin-top: -1px;"  value="1" checked  type="radio" name="ismustsub" >
                     <label style="display:inline-block">否</label>
                     <input style="width: 28px;height:20px;margin-top: -1px;" value="0"  type="radio" name="ismustsub" ></td>
                     <?php else: ?>
                     <td width="127"><label style="display:inline-block">是</label>
                     <input style="width: 28px;height:20px;margin-top: -1px;"  value="1"  type="radio" name="ismustsub" >
                      <label style="display:inline-block">否</label>
                    <input style="width: 28px;height:20px;margin-top: -1px;" value="0" checked type="radio" name="ismustsub" ></td><?php endif; ?>
</tr>

<tr class="vote" style="display: none">
    <th width="83">是否未关注的人可以投票：前提是只有开启强制关注才生效</th>
    <td width="127">
        <?php if($vo["tourvote"] == 1): ?><label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" checked type="radio" name="tourvote" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;"  value="0" class="key" type="radio" name="tourvote" >
            <?php else: ?>
            <label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" type="radio" name="tourvote" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" checked value="0" class="key" type="radio" name="tourvote" ><?php endif; ?>
...
<tr>
    <th width="83">是否开启网页仅浏览</th>
    <td width="127">
        <?php if($vo["isonlyweb"] == 1): ?><label style="display:inline-block">是</label>
        <input style="width: 28px;height:20px;margin-top: -1px;" value="1" checked type="radio" name="isonlyweb" >
        <label style="display:inline-block">否</label>
        <input style="width: 28px;height:20px;margin-top: -1px;"  value="0" type="radio" name="isonlyweb" >
        <?php else: ?>
            <label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" type="radio" name="isonlyweb" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" checked value="0" type="radio" name="isonlyweb" ><?php endif; ?>
    </td>
    <th style="position: relative; left: -58%;">可隐藏投票按钮</th>
</tr>


<tr>
    <th width="83">是否开启用户取关后，减少其票数：</th>
    <td width="127">
        <?php if($vo["isreduce"] == 1): ?><label style="display:inline-block">是</label>
        <input style="width: 28px;height:20px;margin-top: -1px;" value="1" checked type="radio" name="isreduce" >
        <label style="display:inline-block">否</label>
        <input style="width: 28px;height:20px;margin-top: -1px;"  value="0" type="radio" name="isreduce" >
      <?php else: ?>
            <label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" type="radio" name="isreduce" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" checked value="0" type="radio" name="isreduce" ><?php endif; ?>
...
<tr>
    <th width="186px">是否关闭网上报名：</th>
    <td width="127">
        <?php if($vo["isavote"] == 1): ?><label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" checked type="radio" name="isavote" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;"  value="0" type="radio" name="isavote" >
            <?php else: ?>
            <label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" type="radio" name="isavote" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" checked value="0" type="radio" name="isavote" ><?php endif; ?>
    </td>
 <th style="position: relative; left: -58%;">默认开启,需注意和报名时间的关系</th>
</tr>

<tr>
    <th width="186px">是否仅显示浏览量：</th>
    <td width="127">
        <?php if($vo["isviewcount"] == 1): ?><label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" checked type="radio" name="isviewcount" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;"  value="0" type="radio" name="isviewcount" >
            <?php else: ?>
            <label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" type="radio" name="isviewcount" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" checked value="0" type="radio" name="isviewcount" ><?php endif; ?>
    </td>
    <th style="position: relative; left: -58%;">默认开启</th>
</tr>

<tr>
    <th width="186px">是否显示参赛列表并且隐藏最新参赛：</th>
    <td width="127">
        <?php if($vo["isshowNew"] == 1): ?><label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" checked type="radio" name="isshowNew" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;"  value="0" type="radio" name="isshowNew" >
            <?php else: ?>
            <label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" type="radio" name="isshowNew" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" checked value="0" type="radio" name="isshowNew" ><?php endif; ?>
    </td>

    <th style="position: relative; left: -58%;">默认显示最新参赛</th>
</tr>

<tr>
    <th width="186px">参赛列表是否按照从编号小到大排列：</th>
    <td width="127">
        <?php if($vo["isDesc"] == 1): ?><label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" checked type="radio" name="isDesc" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;"  value="0" type="radio" name="isDesc" >
            <?php else: ?>
            <label style="display:inline-block">是</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" value="1" type="radio" name="isDesc" >
            <label style="display:inline-block">否</label>
            <input style="width: 28px;height:20px;margin-top: -1px;" checked value="0" type="radio" name="isDesc" ><?php endif; ?>
    </td>

    <th style="position: relative; left: -58%;">默认关闭,(注意和最新参赛的关系)</th>
</tr>


<th width="186px">是否允许一次投多票：</th>
<td width="127">
    <?php if($vo["isplenty"] == 1): ?><label style="display:inline-block">是</label>
        <input style="width: 28px;height:20px;margin-top: -1px;" value="1" checked type="radio" name="isplenty" >
        <label style="display:inline-block">否</label>
        <input style="width: 28px;height:20px;margin-top: -1px;"  value="0" type="radio" name="isplenty" >
        <?php else: ?>
        <label style="display:inline-block">是</label>
        <input style="width: 28px;height:20px;margin-top: -1px;" value="1" type="radio" name="isplenty" >
        <label style="display:inline-block">否</label>
        <input style="width: 28px;height:20px;margin-top: -1px;" checked value="0" type="radio" name="isplenty" ><?php endif; ?>
</td>

<th style="position: relative; left: -58%;">默认关闭</th>
</tr>

<tr>
    <th width="186px">设定每个分组每个人每天最多能投多少票：</th>
    <td><input style="height: 21px; width: 80px;" type="number" name="groupLimit" value="<?php echo ($vo["groupLimit"]); ?>" class="px" style="width:550px;"></td>
    <th style="position: relative; left: -58%;">为0时，则不限制。且只有为选手分组后才有此功能</th>
</tr>

<tr>
    <th width="186px">搜索框里显示的内容：</th>
    <td><input style="height:30px;width:750px;" type="text" name="innerText" value="<?php echo ($vo["innerText"]); ?>" class="px" style="width:550px;"></td>
</tr>

<th width="83">每个微信用户可投票数(活动进行中时,不要修改此数据)：</th>
...
<tr>
    <th width="83">同一个IP下每天能投多少票(活动进行中时,不要修改此数据。在微信后台投票时，此功能无效)：</th>
...
<tr>
    <th width="186px">详情页分享内容：</th>
    <td><input style="height:30px;width:750px;" type="text" name="sharecontent" value="<?php echo ($vo["sharecontent"]); ?>" class="px" style="width:550px;"></td>
...
<a href="#" onclick="upyunPicUpload('wappicurl',700,400,'<?php echo ($token); ?>')" class="btn btn-primary btn_submit  J_ajax_submit_btn">上传</a> <a href="#" onclick="viewImg('wappicurl')">预览</a>&nbsp;填写图片外链地址，大小为300*300</td>
                ...
                <tr>
                	...
                	<td><input type="text" class="px"  value="<?php echo ($vo['dbdhm']); ?>" name="dbdhm">&nbsp&nbsp&nbsp&nbsp(页面右下角菜单名称）</td>
                </tr>
				<tr>

				<tr>
                	<th>&nbsp;&nbsp;&nbsp;&nbsp;<span class="red">*</span>页面右下角菜单链接</th>
                	<td><input type="text" class="px"  value="<?php echo ($vo['dbdhurl']); ?>" name="dbdhurl">&nbsp&nbsp&nbsp&nbsp(页面右下角菜单链接）(<font color="red" >---做好关注链接之后请到百度缩短去缩短一下链接,不然可能会出错---</font><font color="green" size="5px"><a href="http://dwz.cn/" target="blank">http://dwz.cn/</a></font>)</td>
                </tr> 
...
<td>
<input style="height:30px;width:750px" type="text" name="ydgzts" value="<?php echo ($vo["ydgzts"]); ?>" class="px" onclick="document.getElementById('picurl_src').src=this.value;" id="ydgzts" style="width:300px;">
<a href="#" onclick="upyunPicUpload('ydgzts',700,400,'<?php echo ($token); ?>')" class="btn btn-primary btn_submit  J_ajax_submit_btn">上传</a> <a href="#" onclick="viewImg('ydgzts')">预览</a>&nbsp;填写图片外链地址
</td>
</tr>
<tr>
<th width="83">投票引导关注链接：</th>
<td><input style="height:30px;width:750px;" type="text" name="wxgzurl" value="<?php echo ($vo["wxgzurl"]); ?>" class="px" style="width:550px;"><a href="<?php echo C('site_url');?>/shili/wxyd.htm" target=_blank>&nbsp;<span style="color:red;font-weight:400;font-size:12px;">点击查看示例(---做好关注链接之后请到百度缩短去缩短一下链接,不然可能会出错---<font color="green" size="5px"><a href="http://dwz.cn/" target="blank">http://dwz.cn/</a></font>)</span></a><br><font color=red>(此链接去你的公众号后台素材管理里添加个引导关注素材，然后把素材链接填到这)<font></td>
</tr>
<tr>
...
<td><input style="height:30px;width:750px;" type="text" name="music" value="<?php echo ($vo["music"]); ?>" class="px" style="width:550px;">&nbsp;<span style="color:red;font-weight:400;font-size:12px;">直接填mp3外链地址<font color="blue">(必须是.mp3结尾，不然无法播放)</font>，可以到<a href="http://94001.com"><font color="blue">http://94001.com </font></font>找你喜欢的背景音乐！</span></td>
</tr>

<tr>
<th width="83">首页顶部公告：</th>
<td><input style="height:30px;width:750px;" type="text" name="gonggao" value="<?php echo ($vo["gonggao"]); ?>" class="px" style="width:550px;">&nbsp;<span style="color:red;font-weight:400;font-size:12px;">填的公告内容在投票首页顶部滚动展示！</span></td>
</tr>
<div style="">
<tr>
...
<td style="width:350px;"><input style="height:30px;width:300px;" type="text" name="mp1" value="<?php echo ($vo["mp1"]); ?>" class="px" style="width:550px;">&nbsp;&nbsp;公众号A二维码地址：<input style="height:30px;width:350px;" type="text" name="qr1" value="<?php echo ($vo["qr1"]); ?>" class="px" style="width:550px;"></td>
</tr>
 
<tr class="duogongzhonghao">
<th width="83">公众号B域名：</th>
<td style="width:350px;"><input style="height:30px;width:300px;" type="text" name="mp2" value="<?php echo ($vo["mp2"]); ?>" class="px" style="width:550px;">&nbsp;&nbsp;公众号B二维码地址：<input style="height:30px;width:350px;" type="text" name="qr2" value="<?php echo ($vo["qr2"]); ?>" class="px" style="width:550px;"></td>
</tr>
 
<tr class="duogongzhonghao">
<th width="83">公众号C域名：</th>
<td style="width:350px;"><input style="height:30px;width:300px;" type="text" name="mp3" value="<?php echo ($vo["mp3"]); ?>" class="px" style="width:550px;">&nbsp;&nbsp;公众号C二维码地址：<input style="height:30px;width:350px;" type="text" name="qr3" value="<?php echo ($vo["qr3"]); ?>" class="px" style="width:550px;"></td>
</tr>
</div>
<tr>
